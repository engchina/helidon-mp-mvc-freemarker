...
package io.helidon.webserver.mp.controller;
...
public class WebServerResource {
	 ...
	 */
	private final WebServerProvider greetingProvider;
	 ...
	 */
	@Inject
	public WebServerResource(WebServerProvider greetingConfig) {
