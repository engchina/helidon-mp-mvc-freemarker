...
```
docker build -t helidon-webserver-mp .
```

## Start the application with Docker

```
docker run --rm -p 8080:8080 helidon-webserver-mp:latest
```
...
kubectl get service helidon-webserver-mp  # Verify deployed service
```
